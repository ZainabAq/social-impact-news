...
The final six variables(??? what do you mean by final 6) included the URL, title, publish date, author(s), section, and tags. Example of tags are ‘ads_scary’ and 'health_depression'. Some sections include ‘Crime’, ‘Comedy’, ‘Entertainment’, and ‘Politics’.
...
```{r, out.width = "400px", out.height="300px", echo=FALSE, fig.cap="Figure 4: Classification tree using top 20 variables selected from GBM"}
...
```{r, out.width = "400px", out.height="300px", echo=FALSE, fig.cap=' Figure 5: ROC Curve for SVM model'}
...
![Figure 7: Screenshot of the app](app.png)
